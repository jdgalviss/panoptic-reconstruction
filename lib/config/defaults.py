...
_C.MODEL.PRETRAIN = ""
_C.MODEL.PRETRAIN2D = ""
_C.MODEL.ONLY_PANOPTIC_PRETRAINED = True
_C.MODEL.USE_PRETRAINED = True

_C.MODEL.DEVICE = "cuda"
_C.MODEL.FIX2D = False
_C.MODEL.FIXNORM = False
_C.MODEL.ITERATION = 0

_C.MODEL.COLOR_SPACE = 'RGB'
...
_C.MODEL.FRUSTUM3D.NUM_VIEWS = 1
_C.MODEL.FRUSTUM3D.ENHANCE_CONTRAST = True
_C.MODEL.FRUSTUM3D.SEPARATE_ENCODER = False
...
_C.MODEL.FRUSTUM3D.L1_WEIGHT_64 = 5.0
_C.MODEL.FRUSTUM3D.L1_WEIGHT_128 = 5.0
_C.MODEL.FRUSTUM3D.RGB_WEIGHT_64 = 10.0
_C.MODEL.FRUSTUM3D.RGB_WEIGHT_128 = 10.0
_C.MODEL.FRUSTUM3D.INSTANCE_WEIGHT = 25.0
_C.MODEL.FRUSTUM3D.SEMANTIC_WEIGHT = 10.0
_C.MODEL.FRUSTUM3D.RGB_L1_WEIGHT = 8.0
_C.MODEL.FRUSTUM3D.STYLE_WEIGHT = 0.001
_C.MODEL.FRUSTUM3D.CONTENT_WEIGHT = 0.001
_C.MODEL.FRUSTUM3D.GEN_WEIGHT = 0.75
...
_C.MODEL.FRUSTUM3D.RGB_HEAD = Node()
_C.MODEL.FRUSTUM3D.RGB_HEAD.RESNET_BLOCKS = 2
...
_C.MODEL.FRUSTUM3D.IS_LEVEL_RGB = True
_C.MODEL.FRUSTUM3D.LEVEL_ITERATIONS_RGB = 7500
